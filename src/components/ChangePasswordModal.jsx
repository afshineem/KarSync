      ...
      >
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-3.5">
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="••••••••"
                required
                className="w-full px-3.5 py-2.5 text-xs bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-sky-500 pe-9 text-slate-900 dark:text-white"
              />
              <button
                type="button"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">
                {language === 'fa' ? 'تکرار رمز عبور جدید' : language === 'ku' ? 'دووبارەکردەوەی تێپەڕەوشە' : 'Confirm Password'}
              </label>
              <input
                type="password"
                value={confirmPass}
                ...
                placeholder="••••••••"
                required
                className="w-full px-3.5 py-2.5 text-xs bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-sky-500 text-slate-900 dark:text-white"
              />
            </div>
          </div>
          ...
          <div className="pt-2 flex items-center justify-end gap-2">
            <button
              ...
              onClick={onClose}
              disabled={loading}
              className="px-4 py-2.5 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl border border-slate-300 dark:border-slate-700 transition-colors"
            >
            ...
            <button
              ...
              className="px-5 py-2.5 bg-sky-600 hover:bg-sky-500 text-white font-bold text-xs rounded-xl shadow-md shadow-sky-600/25 transition-all flex items-center gap-1.5 disabled:opacity-50"
            >
